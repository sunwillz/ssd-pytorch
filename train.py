...
def train():
    ...
    print('Trainging images size:', len(dataset))
    ...
    for iteration in range(args.start_iter, cfg['max_iter']):
        ...
        if iteration % 10 == 0:
            ...
            print('iter ' + repr(iteration) + '/' + str(cfg['max_iter']) + ' || epoch: ' + str(epoch) + ' || LR: ' +
                  repr(optimizer.param_groups[0]['lr']) + ' || Loss: %.4f ||' % (loss.item()), end=' ')
